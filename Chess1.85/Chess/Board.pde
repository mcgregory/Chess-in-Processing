              ...
              if(modeSelected){
                          ...
                          if (!whiteTurn && !doPop && doBoardFlip){
                           ...
                           //set up a restart/reset box:
                            fill(50);
                            stroke(255);
                            rect( (8*squSize)+2, (7*squSize)+1, squSize, squSize/3 );
                            fill(255);
                            if(resetOn){
                                text("Click Again", (8*squSize)+2, (7*squSize)+1, squSize, squSize/3 );
                            }
                            else{
                            ...
                            fill(50);
                            stroke(255);
                            rect( (8*squSize)+2, (7*squSize+6)+squSize/3, squSize, squSize/3 );
                            fill(255);
                            if(booUndo){
                                text("Click Again", (8*squSize)+2, (7*squSize+6)+squSize/3, squSize, squSize/3);
                            }
                            else{
                                text("Undo Move", (8*squSize)+2, (7*squSize+6)+squSize/3, squSize, squSize/3 );
                            }
                            //end of box setup
                            //set up flip board box:
                            fill(50);
                            stroke(255);
                            rect( (8*squSize)+2, (6.666*squSize)-2, squSize, squSize/3 );
                            fill(255);
                            if(!doBoardFlip){
                                text("Enable Flip", (8*squSize)+2, (6.666*squSize)-2, squSize, squSize/3 );
                            }
                            else{
                                text("Disable Flip", (8*squSize)+2, (6.666*squSize)-2, squSize, squSize/3 );
                            }
                            ...
                            fill(50);
                            rect( (8*squSize)+2, (1*squSize), squSize, squSize/2);
                            fill(255);
                            text(wpts, (8*squSize)+2, (1*squSize)+1, squSize, squSize/2);
                            text(bpts, (8*squSize)+2, (1*squSize)+squSize/4, squSize, squSize/2); 
...
//methods       
      ...
      public void display(String s){
          ...
          fill(255);
          text(s, 8*squSize+5, squSize/4, squSize-5, squSize/2 );
      ...
      public void displayWhosTurn(String s){
          ...
          fill(50);
          stroke(200);
          rect( (8*squSize)+2, squSize/2+5, squSize, squSize/3);  
        
          fill(255);
          text(s, (8*squSize)+2, squSize/2+5, squSize, squSize/3);
      }
...
//-------------------------------------------------------------------------------------------------------- 
       ...
       public void mouseClicked() {
                ...
                fill(50);
                stroke(225);
                rect( (8*squSize)+2, 2, squSize, squSize/2);
                          
                //destination x,y     
                int x = int(mouseX/squSize);
                int y = int(mouseY/squSize);
                int ybythree = int(mouseY/(squSize/3+1));
                //println(int(mouseY/(squSize/3+1)));
                
                //mode been selected yet?
                
                if(!modeSelected){
                        if(mouseX >= width/3 && mouseX <= width/3 + squSize && 
                          mouseY >= height/3 + squareSize && mouseY <= height/3 + 2*squareSize){
                             twoPlayer = false;
                             modeSelected = true;
                             println("User selected 1 Player mode");
                        }
                        else if(mouseX >= width/3 + squSize && mouseX <= width/3 + 2*squSize && 
                          mouseY >= height/3 + squareSize && mouseY <= height/3 + 2*squareSize){
                             twoPlayer = true;
                             modeSelected = true;
                ...
                if(!promotion && !resetOn && !booUndo && modeSelected){
