       ...
       void draw(){    
              ...
              for ( int i=0; i<8; i++ ) {
               ...
               //set up a restart/reset box:
                ...
                fill(255);
                if(resetOn){
                    text(" Click Again", (8*squSize)+5, (7*squSize)+squSize/2, squSize, squSize/3 );
                }
                else{
                    text(" New Game", (8*squSize)+5, (7*squSize)+squSize/2, squSize, squSize/3 );
                }
                //end of box setup
                ...
                fill(50);
                rect( (8*squSize)+2, (6*squSize)+squSize/4, squSize, squSize);
                fill(255);
                text(wpts, (8*squSize)+2, (6*squSize)+squSize/3, squSize, squSize/2);
                text(bpts, (8*squSize)+2, (6*squSize)+2*squSize/3, squSize, squSize/2); 
...
//---------------------------------------------------------------------------------------------------              
      public void storeMove(int px,int py, int x, int y, int piecenumber){
...
//methods       
      ...
      public boolean boolWhite(int column, int row ) {
       ...
       public boolean isEmptyAt(int column, int row ){
               return( getPieceNum(column, row) == -1 );
       }
//--------------------------------------------------------------------------------------------------
                   ...
                   if (currentKingInCheck(whiteTurn)){
                            ...
                            if(inCheck(firstClickPN) && firstClickPN != -1){
                             ...
                             if ( pieceNumAttacked != -1){
                                        ...
                                        killCounter++;   
                                        moveCounter++;
                                        moveKeeper[moveCounter] = new MoveKeeper(firstClickPN,x,y,initialX,initialY);
                             }    
...
//-------------------------------------------------------------------------------------------------------- 
       ...
       public void mouseClicked() {
                ...
                if(resetOn == false){
                    if (x == 8 && int(mouseY/(squSize/3)) == 23){
                         resetOn = true;
                    }
                }
                else if (x == 8 && int(mouseY/(squSize/3)) == 23){
                     reset(); 
                }
                else {
                    resetOn = false;
