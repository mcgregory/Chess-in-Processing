...
public class Board {
       ...
       int moveCounter =0;
       int squSize, whitePoints, blackPoints;
...
//---------------------------------------------------------------------------------------------------
       ...
       void draw(){ 
              if(modeSelected  && !menuTrigger){
                           ...
                           //highlight last move:
                           if(moveCounter > 0){
                               highlightThisColor(25,10,240,moveKeeper[moveCounter-1].piecenumber);
                           }
                           ...
                           //set up a restart/reset box:
                            fill(50);
                            stroke(255);
                            rect( (8*squSize)+2, (7*squSize), squSize, squSize/3 );
                            fill(255);
                            if(resetOn){
                                text("Click Again", (8*squSize)+2, (7*squSize), squSize, squSize/3 );
                            }
                            else{
                                text("New Game", (8*squSize)+5, (7*squSize), squSize, squSize/3 );
                            }
                            //end of box setup
                            //set up a undo move box:
                            fill(50);
                            stroke(255);
                            rect( (8*squSize)+2, (7*squSize)+squSize/3, squSize, squSize/3 );
                            fill(255);
                            if(booUndo){
                                text("Click Again", (8*squSize)+2, (7*squSize)+squSize/3, squSize, squSize/3);
                            }
                            else{
                                text("Undo Move", (8*squSize)+2, (7*squSize)+squSize/3, squSize, squSize/3 );
                            }
                            //end of box setup
                            //set up flip board box:
                            fill(50);
                            stroke(255);
                            rect( (8*squSize)+2, (6*squSize)+2*squSize/3, squSize, squSize/3 );
                            fill(255);
                            if(!doBoardFlip){
                                text("Enable Flip", (8*squSize)+2, (6*squSize)+2*squSize/3, squSize, squSize/3 );
                            }
                            else{
                                text("Disable Flip", (8*squSize)+2, (6*squSize)+2*squSize/3, squSize, squSize/3 );
                            }
                            ...
                            fill(50);
                            rect( (8*squSize)+2, squSize, squSize, squSize/2);
                            fill(255);
                            text(wpts, (8*squSize)+2, squSize+1, squSize, squSize/2);
                            text(bpts, (8*squSize)+2, squSize+squSize/4, squSize, squSize/2); 
                            
                            //set up a menu button:
                            fill(50);
                            stroke(255);
                            rect( (8*squSize)+2, (6*squSize+ squSize/3), squSize, squSize/3 );
                            fill(255);
                            text("Menu", (8*squSize)+2, (6*squSize + squSize/3), squSize, squSize/3 );
                            //end menu button
                     ...
                     rect( (8*squSize)+2, (6*squSize+ squSize/3), squSize, squSize/3 );
                     fill(255,50,50);
                     text("Exit Menu", (8*squSize)+2, (6*squSize+ squSize/3), squSize, squSize/3 );
              }
...
//-----------------------------------------------------------------------------------------------------    
      void menu(){
               ...
               fill(25,25,255);
               rect(width/3, height/3 + 2*squareSize ,squareSize,squareSize/3);
               fill(25,255,25);
               rect(width/3, height/3+ 7*squareSize/3  ,squareSize,squareSize/3);
               fill(255,25,25);
               rect(width/3, height/3+ 8*squareSize/3  ,squareSize,squareSize/3);
               fill(0);
               textAlign(CENTER);
               text("Menu", width/3,height/3+5,squareSize,squareSize );
               text("Difficult:", width/3, height/3 + 5*squareSize/3 ,squareSize,squareSize/3);
               text("Beginner", width/3, height/3 + 2*squareSize ,squareSize,squareSize/3);
               text("Intermediate", width/3, height/3 + 7*squareSize/3 ,squareSize,squareSize/3);
               text("Advanced", width/3, height/3 + 8*squareSize/3 ,squareSize,squareSize/3);
...
//methods       
      ...
      public void highlightThisColor(int redValue, int greenValue, int blueValue, int piecenumb){
          
          stroke(25,10,240);
          fill(redValue, greenValue, blueValue,150);
          rect( (pieces[piecenumb].getColumn() *squSize), (pieces[piecenumb].getRow()*squSize), squSize, squSize );
      }
      int cnt = 0;
      public void display(String s){
          ...
          fill(255);
          text(s, 8*squSize+5, squSize/4, squSize-5, squSize*2/3 );
      ...
      public void cleanDisplayBox(){
          ...
          fill(50);
          stroke(225);
          rect( (8*squSize)+2, 1, squSize, squSize*2/3-3); 
      }
      public void displayWhosTurn(String s){
          //first clear the area:
          fill(50);
          stroke(225);
          rect( (8*squSize)+2, squSize*2/3-1, squSize, squSize/3+1);  
        
          fill(255);
          text(s, (8*squSize)+2, squSize*2/3, squSize, squSize/3);
      }
...
//--------------------------------------------------------------------------------------------------------        
       public void determineMode(){
                     //determining mode along with color and difficulty 
                       if(!boocolor && !booswitch && mouseX >= width/3 && mouseX <= width/3 + squSize && 
                        ...
                        else if(!boocolor && !booswitch && mouseX >= width/3 + squSize && mouseX <= width/3 + 2*squSize && 
                          mouseY >= height/3 + squareSize && mouseY <= height/3 + 2*squareSize){
                             twoPlayer = true;
                             modeSelected = true;
                        ...
                        else if(!(beginnerset || intermediateset) && booswitch && mouseX >= width/3 && mouseX <= width/3 + squSize && 
                          mouseY >= height/3 + squareSize && mouseY <= height/3 + 2*squareSize){
                             beginnerset = true;
                             drawColorSelection();
                        ...
                        //check which one player mode user wants
                        else if(!(beginnerset || intermediateset) && booswitch && mouseX >= width/3 + squSize && mouseX <= width/3 + 2*squSize && 
                          mouseY >= height/3 + squareSize && mouseY <= height/3 + 2*squareSize){
                        ...
                        //what color?
                        else if((beginnerset || intermediateset) && mouseX >= width/3 && mouseX <= width/3 + squSize && 
                          mouseY >= height/3 + squareSize && mouseY <= height/3 + 2*squareSize){
                             modeSelected = true;
                             whiteselected = true;
                             println("Player chose to be white");
                        }
                        else if((beginnerset || intermediateset) && mouseX >= width/3 + squSize && mouseX <= width/3 + 2*squSize && 
                          mouseY >= height/3 + squareSize && mouseY <= height/3 + 2*squareSize){
                             modeSelected = true;
                             whiteselected = false;
       ...
       public void premoveChecks(int x, int y, int ybythree){
                ...
                if(!modeSelected){
                      ...
                      determineMenu(x, y, ybythree);
                              ...
                              //buttons on side
                              if(resetOn == false && x == 8 && ybythree  == 21){
                                   resetOn = true;
                              }
                              ...
                              else if (!booUndo && x == 8  && ybythree == 22){
                                   booUndo = true;
                              }
                              else if (booUndo && x == 8   && ybythree == 22){
                                   undoMove(); 
...
//-------------------------------------------------------------------------------------------------------- 
       ...
       public void mouseClicked() {
                ...
                int ybythree = int((mouseY+1)/(squSize/3));
                //println(int((mouseY+1)/(squSize/3)));
